...
public class LlistaDoblementEncadenada<E extends Comparable<E>> implements ILlistaGenerica<E> {
   ...
   private class Node<T> {      
    ...
    //Ara crearem la clase interna MyIterator que implementa l'interficie Iterator
    private class MyIterator implements Iterator<E> {
        ...
        // Devuelve true si quedan elementos en la lista
        @Override
        public boolean hasNext() {
            return actual != null;
        }
    
        // Devuelve el siguiente elemento de la lista y mueve el cursor al siguiente
        @Override
        public E next() {
            if (!hasNext()) {
        ...
        public void remove() {
            ...
            try {
                LlistaDoblementEncadenada.this.esborrar(actual.getAnterior().getValor());
            } catch (ElementNoTrobat e) {
                // No se puede dar el caso ya que se ha comprobado que el elemento existe antes de crear el iterador
            }
        }
